...
public class ImageStore {
	...
	public ImageStore(PApplet app, String filename, int tileWidth,
			int tileHeight) {
	...
	private void processImageLine(PApplet app, String[] line) {
		/*
		 * FormatOfLine -> key file r g b a Key (String) -> name of object File
		 * (String) -> route to image file from this directory r, g, b (Int) ->
		 * Color(r, g, b) a (Int) -> alpha
		 */
